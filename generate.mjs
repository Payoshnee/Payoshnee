...
export const USERNAME = process.env.GH_USERNAME || "Payoshnee";
...
export async function main() {
  ...
  // Also write to dist/clone/Payoshnee/github-jet.svg if path exists
  const cloneOut = path.resolve("dist/clone/Payoshnee/github-jet.svg");
